  ...
  return (
    ...
    >
      ...
      <Flex
        w="full"
        h="100px"
        maxW={isVersion2 && !isLessThan1280 ? 'full' : '1660px'}
        flexDir="row"
        alignSelf="center"
        overflow="visible"
        color={textColor}
        ...
        height={isVersion2 && !isLessThan1280 ? 'fit-content' : 'fit-content'}
        padding="20px"
            ...
            <HStack w="full" display="flex" justifyContent="space-between" alignItems="center">
              ...
              {!isVersion2 && (
                <HStack
                  ...
                  spacing="8px"
                  pl={{ base: isVersion2 ? '0px' : '64px', md: isVersion2 ? '0px' : '0px' }}
                >
                  {/* {!isVersion2 && (
              ...
              {isVersion2 && (
                <HStack justifyContent="center" h={{ base: '40px', md: '100vh' }}>
                  <Common.ImpaktButton
                    href="/dashboard"
                    as="a"
