...
return (
  <Modal isOpen={open} scrollBehavior="inside" onClose={() => close()} isCentered>
    ...
    <ModalContent padding={{ base: '1.5em', md: '2em'}}>
      ...
      <ModalCloseButton />
      <VStack align="center" justify="center" w='full' display='flex' flexWrap='wrap' justifyContent='flex-end' rowGap='24px' >
        <Box w='100%'>
          <Text>An email has been sent to <span color='rgba(204, 76, 51, 1)'>member@email.com</span> with a verification link. Please find the email and click the link. Your email address change will take effect once verified. Until then, you need to use your old email address for signing in.</Text>
        </Box>
        <Box w='100%' backgroundColor='rgba(242, 121, 97, 0.1)' display='inline-flex' borderRadius='5px' marginLeft='0px !important' padding='10px'>
        ...
        >
          ...
          <Box w={{ base: '80%', md: '35%', lg: '25%' }} marginLeft={{base: '0px !important', md: '8px !important' }}>
