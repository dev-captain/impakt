              ...
              {twitterLink && (
                ...
                >
                  <Box
                    ...
                    cursor="pointer"
                    onMouseMove={(e: any) =>
                      handleOnMouseOverTeamSocial(e, TwitterLight, 'Twitter')
                    }
                    onMouseLeave={(e: any) => handleOnMouseLeaveTeamSocial(e, Twitter, 'Twitter')}
              ...
              {facebookLink && (
                ...
                >
                  <Box
                    ...
                    transition="0.5s"
                    onMouseMove={(e: any) =>
                      handleOnMouseOverTeamSocial(e, FacebookDark, 'Facebook')
                    }
                    onMouseLeave={(e: any) => handleOnMouseLeaveTeamSocial(e, Facebook, 'Facebook')}
                    _hover={{ backgroundColor: '#FFF', color: '#000' }}
                  >
                    <Image
                      maxW="20px"
