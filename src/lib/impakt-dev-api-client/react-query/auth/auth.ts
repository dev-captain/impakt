...
import type {
  ...
  DiscordAuthControllerRedirectParams,
  TwitterAuthControllerRedirectParams,
} from '../types';
...
export const discordAuthControllerLogin = (
  options?: SecondParameter<typeof customInstance>,
  signal?: AbortSignal,
) => {
  return customInstance<void>(
    { url: `/api/v1/iam/auth/discord/login`, method: 'get', signal },
    options,
  );
};

export const getDiscordAuthControllerLoginQueryKey = () => [`/api/v1/iam/auth/discord/login`];

export type DiscordAuthControllerLoginQueryResult = NonNullable<
  Awaited<ReturnType<typeof discordAuthControllerLogin>>
>;
export type DiscordAuthControllerLoginQueryError = ErrorType<HttpExceptionSchema>;

export const useDiscordAuthControllerLogin = <
  TData = Awaited<ReturnType<typeof discordAuthControllerLogin>>,
  TError = ErrorType<HttpExceptionSchema>,
>(options?: {
  query?: UseQueryOptions<Awaited<ReturnType<typeof discordAuthControllerLogin>>, TError, TData>;
  request?: SecondParameter<typeof customInstance>;
}): UseQueryResult<TData, TError> & { queryKey: QueryKey } => {
  const { query: queryOptions, request: requestOptions } = options ?? {};

  const queryKey = queryOptions?.queryKey ?? getDiscordAuthControllerLoginQueryKey();

  const queryFn: QueryFunction<Awaited<ReturnType<typeof discordAuthControllerLogin>>> = ({
    signal,
  }) => discordAuthControllerLogin(requestOptions, signal);

  const query = useQuery<Awaited<ReturnType<typeof discordAuthControllerLogin>>, TError, TData>(
    queryKey,
    queryFn,
    queryOptions,
  ) as UseQueryResult<TData, TError> & { queryKey: QueryKey };
...
export const discordAuthControllerRedirect = (
  params: DiscordAuthControllerRedirectParams,
  options?: SecondParameter<typeof customInstance>,
  signal?: AbortSignal,
) => {
  return customInstance<void>(
    { url: `/api/v1/iam/auth/discord/redirect`, method: 'get', params, signal },
    options,
  );
};

export const getDiscordAuthControllerRedirectQueryKey = (
  params: DiscordAuthControllerRedirectParams,
) => [`/api/v1/iam/auth/discord/redirect`, ...(params ? [params] : [])];

export type DiscordAuthControllerRedirectQueryResult = NonNullable<
  Awaited<ReturnType<typeof discordAuthControllerRedirect>>
>;
export type DiscordAuthControllerRedirectQueryError = ErrorType<HttpExceptionSchema>;

export const useDiscordAuthControllerRedirect = <
  TData = Awaited<ReturnType<typeof discordAuthControllerRedirect>>,
  TError = ErrorType<HttpExceptionSchema>,
>(
  params: DiscordAuthControllerRedirectParams,
  options?: {
  ...
  const queryKey = queryOptions?.queryKey ?? getDiscordAuthControllerRedirectQueryKey(params);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof discordAuthControllerRedirect>>> = ({
    signal,
  }) => discordAuthControllerRedirect(params, requestOptions, signal);

  const query = useQuery<Awaited<ReturnType<typeof discordAuthControllerRedirect>>, TError, TData>(
    queryKey,
    queryFn,
    queryOptions,
  ) as UseQueryResult<TData, TError> & { queryKey: QueryKey };
...
export const twitterAuthControllerLink = (
  options?: SecondParameter<typeof customInstance>,
  signal?: AbortSignal,
) => {
  return customInstance<void>({ url: `/api/v1/iam/auth/twitter`, method: 'get', signal }, options);
};

export const getTwitterAuthControllerLinkQueryKey = () => [`/api/v1/iam/auth/twitter`];

export type TwitterAuthControllerLinkQueryResult = NonNullable<
  Awaited<ReturnType<typeof twitterAuthControllerLink>>
>;
export type TwitterAuthControllerLinkQueryError = ErrorType<HttpExceptionSchema>;

export const useTwitterAuthControllerLink = <
  TData = Awaited<ReturnType<typeof twitterAuthControllerLink>>,
  TError = ErrorType<HttpExceptionSchema>,
>(options?: {
  query?: UseQueryOptions<Awaited<ReturnType<typeof twitterAuthControllerLink>>, TError, TData>;
  request?: SecondParameter<typeof customInstance>;
}): UseQueryResult<TData, TError> & { queryKey: QueryKey } => {
  const { query: queryOptions, request: requestOptions } = options ?? {};

  const queryKey = queryOptions?.queryKey ?? getTwitterAuthControllerLinkQueryKey();

  const queryFn: QueryFunction<Awaited<ReturnType<typeof twitterAuthControllerLink>>> = ({
    signal,
  }) => twitterAuthControllerLink(requestOptions, signal);

  const query = useQuery<Awaited<ReturnType<typeof twitterAuthControllerLink>>, TError, TData>(
    queryKey,
    queryFn,
    queryOptions,
  ) as UseQueryResult<TData, TError> & { queryKey: QueryKey };
...
export const twitterAuthControllerRedirect = (
  params: TwitterAuthControllerRedirectParams,
  options?: SecondParameter<typeof customInstance>,
  signal?: AbortSignal,
) => {
  return customInstance<void>(
    { url: `/api/v1/iam/auth/twitter/redirect`, method: 'get', params, signal },
    options,
  );
};

export const getTwitterAuthControllerRedirectQueryKey = (
  params: TwitterAuthControllerRedirectParams,
) => [`/api/v1/iam/auth/twitter/redirect`, ...(params ? [params] : [])];

export type TwitterAuthControllerRedirectQueryResult = NonNullable<
  Awaited<ReturnType<typeof twitterAuthControllerRedirect>>
>;
export type TwitterAuthControllerRedirectQueryError = ErrorType<HttpExceptionSchema>;

export const useTwitterAuthControllerRedirect = <
  TData = Awaited<ReturnType<typeof twitterAuthControllerRedirect>>,
  TError = ErrorType<HttpExceptionSchema>,
>(
  params: TwitterAuthControllerRedirectParams,
  options?: {
  ...
  const queryKey = queryOptions?.queryKey ?? getTwitterAuthControllerRedirectQueryKey(params);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof twitterAuthControllerRedirect>>> = ({
    signal,
  }) => twitterAuthControllerRedirect(params, requestOptions, signal);

  const query = useQuery<Awaited<ReturnType<typeof twitterAuthControllerRedirect>>, TError, TData>(
    queryKey,
    queryFn,
    queryOptions,
  ) as UseQueryResult<TData, TError> & { queryKey: QueryKey };
