...
export const guestV1ControllerGetGuestById = (
  ...
  return customInstance<void>({ url: `/api/v1/guest/${id}`, method: 'get', signal }, options);
};
...
>;
export type GuestV1ControllerGetGuestByIdQueryError = ErrorType<unknown>;
...
export type GuestV1ControllerUpdateGuestByIdMutationError = ErrorType<unknown>;
